...
// update key
$f3->set('QUIET', true);
$f3->mock('POST @key_set', array('project' => array('id' => $id), 'keys' => array($key), 'values' => array($new_value)));
$f3->set('QUIET', false);

// check if key is updated
$f3->set('QUIET', true);
...
$test_data['name'] = 'Simple update key';
